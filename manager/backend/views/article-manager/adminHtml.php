						...
						<div class="row"><div class="col-sm-6">
							...
							<div class="col-sm-6">
							    ...
							    <div class="form-group" style="margin-top:-10px;">
										...
										<?= Html::a('添加文章!', \yii\helpers\Url::toRoute(["article-manager/create"]), ['class' => 'btn btn-sm btn-primary']) ?>
							</div>
								</div>
								<?ActiveForm::end();?>
								</div>
