...
?>
					...
					<a href="<?=\yii\helpers\Url::toRoute(["customer/list"])?>" class='btn btn-primary'>返回列表页</a>
...
echo   $form -> field($customer,'name',['options'=>['class'=>'control-group']])
           -> label('客户名称'.Html::tag('span','<font color="red">*</font>',['class'=>'required']),
                    ['for'=>'typeahead'])     
...
echo $form -> field($customer,'sex',["options"=>["class"=>"control-group"]])
           -> label("性别选项".Html::tag('span','<font color="red">*</font>',['class'=>'required']),
                    ['for'=>'selectError'])  
           -> dropDownList([0=>'女',1=>'男']);
...
echo   $form -> field($customer,'telephone',['options'=>['class'=>'control-group']])
           -> label('移动电话'.Html::tag('span','<font color="red">*</font>',['class'=>'required']),
                    ['for'=>'typeahead'])     
           -> textInput(['class'=>'span6 typeahead',
                          'data-provide'=>'typeahead',
                          'data-items'=>'4',
